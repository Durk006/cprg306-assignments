...
export default function NewItem() {
    ...
    return(
        <main className="  flex justify-center">
            <form className=" p-2 m-2 text-black bg-stone-950 max-w-sm w-full" onSubmit={handleSubmit}>
                ...
                <br />
                <button className="bg-lime-300 w-full p-1.5 rounded-lg mb-2 text-Black" type="submit">Add</button>
            </form>
        </main>
    );
}