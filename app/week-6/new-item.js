...
export default function NewItem() {
    ...
    return(
        <main>
            <form className=" p-2 m-2 ml-6 text-black bg-stone-950 max-w-sm w-full" onSubmit={handleSubmit}>
                ...
                <br />
                <button className="bg-lime-300 w-full p-1.5 rounded-lg mb-2 text-Black font-bold " type="submit">+</button>
            </form>
        </main>
    );
}
